  ...
  projects: [
    {
      ...
      use: {
        ...
        ...devices["Desktop Chrome"], // Example: Use iPhone 14 emulation for testing mobile responsiveness.
    ...
    {
      name: "webkit", // Project name for WebKit browser
      use: {
        //...devices["Desktop Chrome"], // Use default desktop WebKit settings.
        browserName: "webkit", // Example: Use WebKit channel for Safari testing.
        headless: false,
      },
    },
    {
      name: "iphone14", // Project name for iPhone 14 emulation
      use: {
        ...devices["iPhone 14"], // Use iPhone 14 emulation for testing mobile responsiveness.
        channel: "chrome", // Example: Use Chrome channel for mobile testing.
        headless: false,
      },
    },
  ],
